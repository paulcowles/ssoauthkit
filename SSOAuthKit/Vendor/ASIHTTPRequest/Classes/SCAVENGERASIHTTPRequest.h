...
extern NSString *SCAVENGERASIHTTPRequestVersion;
...
extern NSString* const SCAVENGERNetworkRequestErrorDomain;
...
extern unsigned long const SCAVENGERASIWWANBandwidthThrottleAmount;
